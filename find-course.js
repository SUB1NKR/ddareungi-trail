...
const courses = [
  {
    id: 1,
    name: "도심 속 메타세쿼이아 숲길 따라 따릉이가 간다~",
    description: "월드컵공원 메타세쿼이아 숲길과 난지한강공원을 함께 느낄 수 있는 짧고 편안한 힐링 코스입니다.",
    time: "14분",
    distance: "5km",
  ...
  },
  {
    id: 2,
    name: "불광천 따릉이길",
    description: "봄에는 벚꽃이 피고, 불광천과 한강, 망원재래시장과 망리단길까지 함께 즐길 수 있는 산책형 코스입니다.",
    time: "25분",
    distance: "6km",
  ...
  {
    id: 3,
    name: "용산에서 노들섬, 여의도까지 자전거로 한번에!",
    description: "용산역에서 노들섬과 여의도한강공원까지 이어지는 코스로, 한강 풍경과 피크닉 감성을 함께 즐길 수 있습니다.",
    time: "23분",
    distance: "5km",
  ...
  {
    id: 4,
    name: "고궁, 도시 그리고 자연을 달리는 서울 한 줄 요약길.",
    description: "경복궁, 광화문, 덕수궁, 서울역, 용산, 이촌한강공원까지 서울의 고궁과 도심, 자연을 한 번에 만나는 코스입니다.",
    time: "37분",
    distance: "9km",
  ...
  {
    id: 5,
    name: "한강공원으로 즐기는 따릉이길",
    description: "가양동에서 여의도까지 한강공원과 더현대를 함께 즐길 수 있어 연인과 나들이하기 좋은 코스입니다.",
    time: "35분",
    distance: "8km",
  ...
  {
    id: 6,
    name: "한강 따라 자전거공원 따릉따릉",
    description: "대부분 자전거도로로 이루어져 안전하게 달리기 좋고, 샛강 생태공원의 신선한 공기까지 느낄 수 있습니다.",
    time: "34분",
    distance: "9km",
  ...
  {
    id: 7,
    name: "야경이 아름다운 따릉이 퇴근길",
    description: "강남과 여의도를 잇는 한강변 퇴근길 코스로, 야경과 건강한 하루 마무리를 함께 즐길 수 있습니다.",
    time: "48분",
    distance: "13km",
  ...
  {
    id: 8,
    name: "홍제천 폭포에서 경의선 숲길 따라, 젊음의 홍대로 도심으로",
    description: "홍제천 폭포와 경의선숲길, 연희동과 홍대까지 이어지는 젊고 활기 있는 도심 탐험 코스입니다.",
    time: "28분",
    distance: "8km",
  ...
  {
    id: 9,
    name: "마포대교를 건너며 느끼는 여의도와 한강",
    description: "마포대교를 건너며 여의도와 한강의 풍경, 바람, 노을과 야경까지 다양하게 느낄 수 있는 짧은 코스입니다.",
    time: "17분",
    distance: "4km",
  ...
  {
    id: 10,
    name: "청계천에서 중랑천을 따라 한강까지",
    description: "청계천에서 중랑천을 지나 한강까지 이어지는 물길 중심 코스로, 서울의 대표 하천을 가까이 느낄 수 있습니다.",
    time: "26분",
    distance: "6km",
  ...
  {
    id: 11,
    name: "따릉이와 함께 하는 한강 야경 여행",
    description: "뚝섬유원지역에서 동호대교, 반포대교 무지개분수, 노들섬까지 이어지는 한강 야경 감상 코스입니다.",
    time: "57분",
    distance: "13km",
  ...
  },
  {
    id: 12,
    name: "초록이 깃든 길",
    description: "JYP 사옥과 제2롯데월드를 잇고, 성내천의 벚꽃과 다양한 식물을 함께 만날 수 있는 초록 힐링 코스입니다.",
    time: "17분",
    distance: "4km",
  ...
  },
  {
    id: 13,
    name: "탁트인 목가적 풍경길",
    description: "탄천길에서 한강자전거길로 이어지며 미루나무, 강물, 잠실 일대의 탁 트인 풍경을 만나는 코스입니다.",
    time: "32분",
    distance: "5km",
  ...
  },
  {
    id: 14,
    name: "탄천따라 따릉따릉",
    description: "탄천의 아름다운 경관과 도심 속 자연을 느끼며 가볍게 달릴 수 있는 짧은 자연 코스입니다.",
    time: "15분",
    distance: "4km",
  ...
  {
    id: 15,
    name: "여의천, 양재천과 탄천을따라 한강까지 즐기는 따릉이길",
    description: "여의천, 양재천, 탄천을 지나 한강까지 이어지는 긴 코스로, 자연과 강바람을 충분히 즐길 수 있습니다.",
    time: "1시간 7분",
    distance: "20km",
  ...
  {
    id: 16,
    name: "7호선 꽃구경! 장미꽃, 벚꽃길, 그리고 중랑천",
    description: "송정제방길의 벚꽃과 중랑장미공원을 함께 만나는 꽃구경 중심의 중랑천 자전거 코스입니다.",
    time: "37분",
    distance: "9km",
  ...
  {
    id: 17,
    name: "비바람 안 맞고 달리는 8km 코스 아시나요?",
    description: "도림천의 지붕 덮인 자전거도로를 따라 비바람과 더위를 피하며 달릴 수 있는 색다른 안전 코스입니다.",
    time: "42분",
    distance: "10km",
  ...
  },
  {
    id: 18,
    name: "힐링 출퇴근길 따릉이길",
    description: "안양천을 따라 출퇴근 스트레스를 덜고, 튤립과 벚꽃, 장미꽃길을 만날 수 있는 직장인 힐링 코스입니다.",
    time: "23분",
    distance: "6km",
  ...
  },
  {
    id: 19,
    name: "물멍숲멍",
    description: "자양한강공원에서 물멍을 시작해 어린이대공원과 중랑천까지 이어지는 물과 숲의 힐링 코스입니다.",
    time: "51분",
    distance: "6km",
  ...
  },
  {
    id: 20,
    name: "청계천 따라 따릉따릉",
    description: "청계천 옆 자전거길을 달리며 동대문, 종묘, 광화문 등 서울의 도심 풍경을 함께 구경할 수 있습니다.",
    time: "22분",
    distance: "5km",
...
function getBestCourse() {
  const scores = courses.map((course) => {
    ...
    uniqueSelectedTags.forEach((tag) => {
      if (course.name.includes(tag) || course.description.includes(tag)) {
        score += 1;
      }
    });
